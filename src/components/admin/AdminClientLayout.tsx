  ...
  return (
    <div className="h-[100dvh] bg-[#FAF8F5] flex font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        <main id="admin-main-scroll" data-lenis-prevent className="flex-1 overflow-y-auto p-4 md:p-8 w-full [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
