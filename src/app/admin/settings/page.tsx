...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6 w-full max-w-5xl pb-20">
      <div className="flex items-center justify-between bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-100 sticky top-0 z-30">
        ...
        <button
          onClick={handleSave}
          disabled={isSaving}
          className="flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 bg-emerald-600 text-white font-bold rounded-xl hover:bg-emerald-700 transition-colors shadow-sm shadow-emerald-200 text-sm sm:text-base"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-200 space-y-6 md:col-span-2">
          <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2 border-b pb-2">
