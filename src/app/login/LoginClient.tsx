      ...
      <AnimatePresence mode="wait">
        {showWelcome ? (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[9999] bg-[#f4f5f4] flex flex-col items-center justify-center overflow-hidden"
          >
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl font-heading font-black text-[#5a6b5e] tracking-tight">
                Welcome, <span className="text-[#1a1a1a] italic">{name || "Friend"}</span>!
              </h1>
            </motion.div>
          </motion.div>
        ) : (
